...
var ASM_CONSTS = {
  4516652: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4516707: ($0) => { performance.now = function() { return $0; }; },  
 4516755: ($0) => { performance.now = function() { return $0; }; },  
 4516803: () => { performance.now = Module['emscripten_get_now_backup']; }
};
